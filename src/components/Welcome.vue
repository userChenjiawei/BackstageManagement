<!-- <template>
    <div>
        <img src="https://img2.baidu.com/it/u=2927586094,212838758&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=500" alt="">
    </div>
</template>
<script>
export default {
...
<script>
  export default {
    props: {
      ...
      lineColor: {
        type: String,
        default: 'rgba(0,0,200,0.6)' // 线的颜色
      },
      roundColor: {
        type: String,
        default: 'rgba(250,0,0,0.2)' // 星星的颜色
      },
    },
    data() {
      return {
